...
public extension Endpoint.Group.Direct {
    ...
    var conversations: Endpoint.Paginated<SocialGraphKit.Conversation.Collection, String?, Error> {
    ...
    var requests: Endpoint.Paginated<SocialGraphKit.Conversation.Collection, String?, Error> {
...
fileprivate extension Endpoint.Group.Direct {
    ...
    func inbox(isPending: Bool) -> Endpoint.Paginated<SocialGraphKit.Conversation.Collection, String?, Error> {
        .init { secret, session, pages in
            Pager(pages) {
                Request.direct
                    ...
                    .map(\.data)
                    .wrap()
                    .map(SocialGraphKit.Conversation.Collection.init)
