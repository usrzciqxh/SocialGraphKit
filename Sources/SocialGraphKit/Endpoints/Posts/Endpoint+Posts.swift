...
public extension Endpoint.Group.Posts {
    ...
    var archived: Endpoint.Paginated < SocialGraphKit.Media.Collection,
    ...
    var saved: Endpoint.Paginated<SocialGraphKit.Media.Collection, String?, Error> {
        Endpoint.saved.posts
    }

    /// A list of posts liked by the logged in user.
    var liked: Endpoint.Paginated < SocialGraphKit.Media.Collection,
                                  RankedOffset<String?, String?>,
                                  Error> {
