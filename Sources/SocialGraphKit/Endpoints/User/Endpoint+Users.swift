...
public extension Endpoint {
    ...
    static func users(matching query: String) -> Endpoint.Paginated < SocialGraphKit.User.Collection,
...
public extension Endpoint.Group.Users {
    ...
    var requests: Endpoint.Paginated<SocialGraphKit.User.Collection, String?, Error> {
        .init { secret, session, pages in
            Pager(pages) {
                Request.friendships
                    .pending
