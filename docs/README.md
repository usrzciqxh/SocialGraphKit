<br />
<img alt="Header" src="https://github.com/sbertix/SocialGraphKit/blob/main/Resources/header.png" height="72" />
<br />

[![Swift](https://img.shields.io/badge/Swift-5.2-%23DE5C43?style=flat&logo=swift)](https://swift.org)
[![codecov](https://codecov.io/gh/sbertix/SocialGraphKit/branch/main/graph/badge.svg)](https://codecov.io/gh/sbertix/SocialGraphKit)
[![Telegram](https://img.shields.io/badge/Telegram-SocialGraphKit-blue?style=flat&logo=telegram)](https://t.me/socialgraphkit)
<br />
...
**SocialGraphKit** is a wrapper for [**Instagram**](https://instagram.com) Private API, written entirely in (modern) **Swift**.
...
In order to bypass these limitations, **SocialGraphKit** relies on the API used internally by the Android and iOS official **Instagram** apps, requiring no _API token_, and allowing to reproduce virtually any action a user can take.
Please just bear in mind, as they're not authorized for external use, you're using them at your own risk.

<br />

> What's **SocialGraphKitCrypto**?

Relying on encryption usually requires specific disclosure, e.g. on submission to the **App Store**.

[Despite **SocialGraphKit**, as all libraries relying on unathorized third-party APIs, cannot be considered **App Store** safe](https://9to5mac.com/2020/08/27/apple-rejects-watch-for-tesla-app-as-it-starts-requiring-written-consent-for-third-party-api-use/), we still value separating everything depending on [encryption](https://developer.apple.com/documentation/security/complying_with_encryption_export_regulations) into its owen target library, we call **SocialGraphKitCrypto**.
Keep in mind features like `BasicAuthenticator`, a non-visual `Authenticator`, or `KeychainStorage`, the safe and preferred way to store `Secret`s, or even the ability to post on your feed and upload stories are **SocialGraphKitCrypto** only.
...
## Status
![push](https://github.com/sbertix/SocialGraphKit/workflows/push/badge.svg)
![GitHub release (latest by date)](https://img.shields.io/github/v/release/sbertix/SocialGraphKit)

You can find all changelogs directly under every [release](https://github.com/sbertix/SocialGraphKit/releases), and if you care to be notified about future ones, don't forget to subscribe to our [Telegram channel](https://t.me/SocialGraphKit).

> What's next?

[Milestones](https://github.com/sbertix/SocialGraphKit/milestones), [issues](https://github.com/sbertix/SocialGraphKit/issues), as well as the [_WIP dashboard_](https://github.com/sbertix/SocialGraphKit/projects/1), are the best way to keep updated with active developement.

Feel free to contribute by sending a [pull request](https://github.com/sbertix/SocialGraphKit/pulls).
...
1. Paste `https://github.com/sbertix/SocialGraphKit.git`.
1. Follow the steps.
1. Add **SocialGraphKitCrypto** together with **SocialGraphKit** for the full experience.
...
- [**SocialGraphKit**](https://sbertix.github.io/SocialGraphKit/SocialGraphKit) depends on [**ComposableRequest**](https://github.com/sbertix/ComposableRequest), an HTTP client originally integrated in **SocialGraphKit**.\
...
- [**SocialGraphKitCrypto**](https://sbertix.github.io/SocialGraphKit/SocialGraphKitCrypto), depending on [**Swiftchain**](https//github.com/sbertix/Swiftchain) and a fork of [**SwCrypt**](https://github.com/sbertix/SwCrypt), can be imported together with **SocialGraphKit** to extend its functionality, accessing the safer `KeychainStorage` and encrypted `Endpoint`s (e.g. `Endpoint.Friendship.follow`, `Endpoint.Friendship.unfollow`).
    </p>
</details>
...
## Usage
Check out our [Examples](Examples) or visit the (_auto-generated_) documentation for [**SocialGraphKit**](https://sbertix.github.io/SocialGraphKit/SocialGraphKit) and [**SocialGraphKitCrypto**](https://sbertix.github.io/SocialGraphKit/SocialGraphKitCrypto) to learn about use cases.   
...
`Authenticator.Group.Basic` is a code based `Authenticator`, supporting 2FA, defined in **SocialGraphKitCrypto**: all you need is a _username_ and _password_ and you're ready to go.

<details><summary><strong>Example</strong></summary>
    <p>

```swift
import SocialGraphKitCrypto
...
In older versions of **SocialGraphKit** we let the user set a delay between the firing of a request, and its actual dispatch. 
...
**SocialGraphKit** defines a `static` `URLSession` (`URLSession.instagram`) fetching one resource at a time. Relying on this is the preferred way to deal with Instagram "spam" filter.
