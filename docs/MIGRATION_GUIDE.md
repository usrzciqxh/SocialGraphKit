...
`5.0.0` brings a lot of changes to **SocialGraphKit**: mainly an entirely rewritten `Endpoint` hierarchy
and a much better performing [**ComposableRequest**](https://github.com/sbertix/SocialGraphKit) written on **Combine**,
