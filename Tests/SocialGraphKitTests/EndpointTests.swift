...
@testable import SocialGraphKit
@testable import SocialGraphKitCrypto
...
internal final class EndpointTests: XCTestCase {
    ...
    func testEndpointPosts() {
        ...
        if let image = Agnostic.Color.blue.image(size: .init(width: 640, height: 360)),
           let url = URL(string: "https://raw.githubusercontent.com/sbertix/SocialGraphKit/main/Resources/landscape.mp4"),
    ...
    func testEndpointStories() {
        ...
        //        if let wrapper = performTest(on: Endpoint.stories.upload(video: URL(string: "https://raw.githubusercontent.com/sbertix/SocialGraphKit/main/Resources/portrait.mp4")!,
